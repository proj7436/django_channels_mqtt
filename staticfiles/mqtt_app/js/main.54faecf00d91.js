...
function add_log(topic, content_hex, qos) {
  ...
  ul.insertAdjacentHTML(
    "afterbegin",
    `<li class='container-device-log' style="cursor: pointer;corlor:black"><a style="text-decoration: none;"  target="_blank" href="/data/${topic}/${qos}/${content_hex}/">Topic: ${topic} QoS: ${qos} ${content_hex}</a></li>`
  );
}
